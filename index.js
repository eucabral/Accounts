...
function createAccount() {
    console.log(chalk.bgGreen.black('Parabens por usar o Accounts!'))
...
function addAmount(accountName, Amount) {
    ...
    console.log(chalk.green(`Deposito realizado no valor de R$${Amount} reais na sua conta`)
    ),
    operation()
...
function getAccountBalance() {
    inquirer.prompt ([
        ...
        const accountData = getAccount(accountName)
        console.log(chalk.bgBlue.black(`O saldo da sua conta e R$${accountData.balance} reais`),
        )
        operation()
...
function removeAmount(accountName,amount) {
    ...
    console.log(
        chalk.green(`Foi realizado um saque de r$${amount} reais da sua conta!`)
    )
    operation()
